...
### 效果预览
| 主页 | 通讯录 | 发现 | 个人页面 | App 展示 |
| ---- | ------ | ---- | -------- | -------- |
| ![](Chat/screenshots/device/chat_home.jpeg) | ![](Chat/screenshots/device/chat_address.jpeg) | ![](Chat/screenshots/device/chat_found.jpeg) | ![](Chat/screenshots/device/chat_me.jpeg) | ![](Chat/screenshots/device/app.jpeg) |
...
1.适配API version 12版本SDK，SDK版本号(5.0.0.32),镜像版本号(5.0.0.32)。

2.需要使用DevEco Studio 版本号(4.1.3.700)版本才可编译运行。
